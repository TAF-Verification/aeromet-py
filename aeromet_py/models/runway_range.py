...
class RunwayRange(Group):
    """Basic structure to for runway range groups in reports from land stations."""

    _name = DataDescriptor()
    _rvr_low = DataDescriptor()
    _low_range = DataDescriptor()
    _rvr_high = DataDescriptor()
    _high_range = DataDescriptor()
    _trend = DataDescriptor()
