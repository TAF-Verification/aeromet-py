...
def test_mvfr():
    ...
    for code in codes:
        metar = Metar(code)
        assert metar.flight_rules == "MVFR"
...
def test_lifr():
    ...
    for code in codes:
        metar = Metar(code)
        assert metar.flight_rules == "LIFR"
...
def test_vlifr():
    ...
    for code in codes:
        metar = Metar(code)
        assert metar.flight_rules == "VLIFR"


def test_trend_vfr():
    codes = [
        "METAR KJFK 250451Z 17010KT 1/8SM R04R/4000VP6000FT -RA BR BKN002 OVC025 11/11 A2949 ",
        "METAR MMPR 011844Z 26008KT 1/4SM SN SCT050 BKN100 24/16 A2994 RMK 8/501",
        "METAR MRLM 152100Z 06008KT 1500 TSRA OVC001CB 21/21 A2978",
        "METAR TUPJ 032200Z 10013KT 2SM BR VV001 22/21 A3002 RMK Q1017 VIS16KM",
        "METAR SKCG 012200Z 29006KT 260V330 0500 FG OVC003 28/24 Q1008 RMK A2979",
...
def test_no_data_to_set_flight_rules():
    codes = [
    ...
    for code in codes:
        metar = Metar(code)
        assert metar.flight_rules == None


def test_trend_flight_rules_nosig():
    code = "SPECI MROC 062121Z VRB02KT 9999 3000SW -RA VCTS FEW020CB SCT035 BKN100 19/19 A2996 RETS NOSIG"
    metar = Metar(code)

    assert metar.weather_trends[0].flight_rules == None
