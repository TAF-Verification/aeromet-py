...
flight_rules_metars: Dict[Optional[str], List[str]] = {
    "VFR": [
...
@pytest.mark.parametrize(
    "rule,codes",
    [(rule, codes) for rule, codes in flight_rules_metars.items()],
)
def test_flight_rules(rule, codes):
    for code in codes:
        metar = Metar(code)
        assert metar.flight_rules == rule
