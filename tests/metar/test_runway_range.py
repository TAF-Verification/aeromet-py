...
def test_runway_range():
    metar = Metar("METAR SCFA 121300Z 21008KT 9999 3000W R07L/M0150V0600U TSRA FEW020 20/13 Q1014 NOSIG")
...
def test_runway_range_no_high():
    metar = Metar("METAR SCFA 121300Z 21008KT 9999 3000W R25C/P0150U TSRA FEW020 20/13 Q1014 NOSIG")
    rwy_range = metar.runway_range
